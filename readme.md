# Проект 5 модуля, использование инструментов для отладки в Rust
...
6. Исправлен метод подсчета четных значений с доустпом за пределы среза, реализованы тесты: sum_even_numbers_boundary, sum_even_numbers_empty, sum_even_numbers_no_even
...
## 4. Реализованы регрессионные тесты по найденным проблемам
 - test_leak_buffer
 - test_use_after_free
 ...
 - реализован тесты Miri, Valgrind, санитайзенры ./scripts/test-all.sh (тесты UB, гонки данных)
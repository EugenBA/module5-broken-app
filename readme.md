...
4. Запуск Valgrind
   ...
   Артифакты сбора данных аллокаций: artifacts/before_massif.out.25473, artifacts/after_massif.out.25473
...
6. Запуск инструментов оптимизации 
     ...
     Артифакты: artifacts/flamegraph_before.svg, artifacts/flamegraph_after.svg
     ...
     Артифакты: artifacts/baseline_before.txt, artifacts/baseline_after.txt, artifacts/criterion_before, artifacts/criterion_after 
